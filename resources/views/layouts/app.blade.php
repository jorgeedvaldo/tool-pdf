...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-24XTW9LKS1"></script>
    <script>
    ...
    <meta property="og:title" content="@yield('title', __('messages.title'))" />
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('tool.compress_pdf') }}"><i class="bi bi-arrows-angle-contract me-1"></i>{{ __('messages.compress_pdf') }}</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu shadow-lg border-0 mt-2" aria-labelledby="allToolsDropdown">
                        ...
                        <li><a class="dropdown-item" href="{{ route('tool.compress_pdf') }}"><i class="bi bi-arrows-angle-contract me-2 text-success"></i>{{ __('messages.compress_pdf') }}</a></li>
                        <li><a class="dropdown-item" href="{{ route('tool.edit_pdf') }}"><i class="bi bi-pencil-square me-2 text-info"></i>{{ __('messages.edit_pdf') }}</a></li>
